...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $image='"https://golefts.xyz/payment/'.$row2[6].'.jpeg"';
    $dataRow = $dataRow."<tr><td>$row2[5]</td><td onclick='window.location.href=$image;' style='background:green;'><img src=$image style='height: 50px' ></td><td>$row2[2]</td><td onclick='window.location.href=$alink;' style='background:green;'>YES</td><td onclick='window.location.href=$dlink;'style='background:red;'>NO</td></tr>";
}

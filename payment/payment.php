...
<head>
    ...
    <script>
            ...
            setTimeout(function() {
               window.location.replace("https://golefts.xyz/payment/confirmpayment?am=<?php echo $am; ?>&user=<?php echo $user; ?>&mode="+mode); 
            },100);}
        </script>
</head>
                    ...
                    <div class="col-12 m-record">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 justify mt-3 tfcdg">
                                ...
                                <p>The transaction funds are guaranteed by the 0076 platform throughout the process,

<?php
include "./conn.php";
//$connect = new PDO("mysql:host=173.201.253.19;dbname=0076", "0076", "Trova@123");
...
if ($action == 'getuserinfo') {
	$user = $_GET['user'];
	$sql = "SELECT id,nickname,username,usercode,ROUND(balance) AS balance,ROUND(bonus) AS bonus FROM `users` WHERE username='$user'";

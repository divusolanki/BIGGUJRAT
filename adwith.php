...
{$query0 =  "SELECT  account,ifsc,upi,paytm FROM users  WHERE username='$row2[1]'";
...
$paytm=$row3['paytm'];
    ...
    $dataRow = $dataRow."<tr><td>$row2[1]</td><td>$row2[2]</td><td>$row2[3]</td><td>$paytm</td><td>$upi</td><td onclick='window.location.href=$agree;' style='background:green;'>AGREE</td><td onclick='window.location.href=$alink;' style='background:green;'>YES</td><td onclick='window.location.href=$dlink;'style='background:red;'>NO</td></tr>";
}
...
">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="https://wa.me/917087902758/">Contact Developer</a>                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                           
                            Designed By <a href="#">CodeMaster</a>

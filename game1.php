...
define('DB_USERNAME', 'cmeyiuvj_fast');
define('DB_PASSWORD', 'cmeyiuvj_fast');
define('DB_NAME', 'cmeyiuvj_fast');
...
$conn->query($addwin2);
$addfairwin2="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner2 AND period=$period AND ans='$res'";
...
$conn->query($addwin3);
$addfairwin3="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner3 AND period=$period AND ans='$res'";
$conn->query($addfairwin3);
...
$conn->query($addwin4);
$addfairwin4="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner4 AND period=$period AND ans='$res'";
$conn->query($addfairwin4);
...
$fbets1= $row1['amount'];
$winamount1= ($fbets1-(5/100)*$fbets1)*4.5;


$addfairwin="UPDATE users SET balance= balance +$winamount1 WHERE username=$winner1";
$conn->query($addfairwin);
$addfairwin1="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner1 AND period=$period AND ans='violet'";
$conn->query($addfairwin1);
...
$conn->query($addwin5);
$addfairwin5="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner5 AND period=$period AND ans='$res'";
$conn->query($addfairwin5);
...
$winamount12= ($fbets12-(5/100)*$fbets12)*4.5;

$addfairwin2="UPDATE users SET balance= balance+$winamount12 WHERE username=$winner12";
$conn->query($addfairwin2);
$addfairwin12="UPDATE saprebetting SET res='success',price=$num,number=$prices,color='$res',color2='$res1' WHERE username=$winner12 AND period=$period AND ans='violet'";
$conn->query($addfairwin12);
